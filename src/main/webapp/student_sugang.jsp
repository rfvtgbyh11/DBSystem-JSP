...
<h2> 수강 신청 </h2> <h3> 이름 <%=name%> <%=credit%>학점 / 18학점</h3>

<form name="findC" action="student_sugang.jsp" method="post">
...
<div>
    ...
    <table>
            ...
            if (listsz != 0) {
                for (UserDAO._ClassInfo _class : list) {
                    ...
                    for (int i=0; i<_class.day.length; i++) {
                        if (_class.day[0] == null){
                            out.println("(온라인)"); break;
                        }
                        if (_class.day[i] == null) break;
                    ...
                    for (int i=0; i<_class.roomNum.length; i++) {
                        if (_class.roomNum[0] == null){
                            out.println("(온라인)"); break;
                        }
                        if (_class.roomNum[i] == null) break;
        ...
        <td><button id="<%=_class.classId+_class.classId%>" type="button" onclick="location.href='addwish.jsp?classID=<%=_class.classId%>';"> 버튼 </button></td><%
