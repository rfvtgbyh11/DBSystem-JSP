...
<%
    ...
    if (class_id.equals("") || class_no.equals("") || course_id.equals("") || person_max.equals("") || lecturer_id.equals("") || prd1_day.equals("") || (!prd1_day.equals("온라인") && (prd1_begin.equals("") || prd1_end.equals("") || prd1_room.equals(""))) || prd2_day.equals("") || (!prd2_day.equals("온라인") && (prd2_begin.equals("") || prd2_end.equals("") || prd2_room.equals("")))) {
        script.println("<script>");
        script.println("alert('입력이 안된 항목이 있습니다.')");
        script.println("location.href='update_class.jsp?class_id="+class_id+"';");
        script.println("</script>");
        script.close();
    }

    ret = userDAO.updateClass(class_id, class_no, course_id, person_max, lecturer_id, prd1_day, prd1_begin, prd1_end, prd1_room, prd2_day, prd2_begin, prd2_end, prd2_room);
    if (ret == 0){
        script.println("<script>");
        script.println("alert('과목이 수정되었습니다.')");
