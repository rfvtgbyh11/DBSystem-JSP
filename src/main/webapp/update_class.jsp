...
<%
  ...
  if (request.getParameter("class_id") != null) class_id = request.getParameter("class_id");
  else response.sendRedirect("admin_course.jsp");
...
<form name="addC" action="update_class_action.jsp" method="post">
